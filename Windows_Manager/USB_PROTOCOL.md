...
@DVS {"type":"config","id":2,"gain":0.300,"gains":0.300,"gaint":0.550,"format":0,"brightness":40,"pairWindow":60,"baseRpm":33.3333,"batteryLow":3.50,"lowBatteryLedAlert":true,"apFallback":true,"button1Action":2,"button2Action":0}
...
@DVS REPAIR id=7
@DVS SWAP_DECKS id=8
@DVS SET_CONFIG gain=0.300 fmt=0 bri=40 pwin=60 base=33.3333 blow=3.50 lbled=1 ap=1 btn1=2 btn2=0 id=9
...
`lbled`, `btn1`, and `btn2` are optional for backward compatibility; when
omitted, the receiver keeps its corresponding currently stored setting.
