...
- Receiver firmware advanced to 1.2.6.
...
- Removed the redundant Emergency AP availability toggle; assigning the AP
  action to either button now always enables that action.
